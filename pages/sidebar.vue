...
<template>
    <aside class="sidebar">
      ...
      <li><NuxtLink to="/InboxPage"><i class="bi bi-envelope" id = "inbox-icon"></i></NuxtLink></li>
...
nuxt-link > a:visited,
nuxt-link:visited,
nuxt-link > a:visited .bi,
nuxt-link:visited .bi {
  color: inherit !important; /* Using !important to ensure override */
}
  </style>

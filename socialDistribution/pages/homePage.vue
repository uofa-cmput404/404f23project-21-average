...
.post-popup {
  ...
  align-items: center;
  z-index: 1000; /* To ensure it's on top of other content */
}
...
.btn-close {
  position: absolute;
  width: 30px;  /* Square button dimensions */
  height: 30px;
  top: 10px;
  right: 10px;
  background-color: black;
  ...
  padding: 0; /* Override Bootstrap's padding to maintain the square shape */
}
